    ...
    <section>
        <div class="container py-3">
            <div class="row justify-content-center">
                <div class="col-10">
                    <h1 class=" z-depth-2 d-inline-block px-5">Sécurité</h1>
                </div>
            </div>
            <div class="row justify-content-center">
            <?php
                ...
                <div class="row justify-content-center">
                    ...
                    <div class=" col-12 col-lg-8 px-3">
                        <div class="card-block px-3">
                            ...
                            <a href="<?=$item->link?>" type="button" class="btn btn-md rounded-pill my-2 float-right">Aller vers l'article</a>
                        </div>
                    </div>
                </div>
            </div>
